...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, glm::radians(dedo1art1), glm::vec3(0.0f, 0.0, 1.0f));
		...
		model = glm::rotate(model, glm::radians(dedo1art2), glm::vec3(0.0f, 0.0, 1.0f));
