...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //light
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.ambient"), 0.3f, 0.6f, 0.3f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.diffuse"), 0.8f, 0.7f, 0.1f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.5f, 0.2f, 0.1f);
